...
function CrudDocumentosGuia({ id, carpeta, direccion}) {
                            ...
                            {datitos.map((dato) => (
                                <tr key={dato.id}>
                                    <td style={{
                                        ...
                                        <img style={{ width: '28%', }} src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/87/PDF_file_icon.svg/1667px-PDF_file_icon.svg.png" />
                                    </td>
...
export default CrudDocumentosGuia